...
function sil() {
    ...
    secilen.remove();
    document.getElementById("sonuc").innerHTML = secilen.textContent+" adlı seçiminiz silindi"
}
...
function tamamla() {
    ...
    sil();
    document.getElementById("sonuc").innerHTML = secilen.textContent+ " tamamlananlara eklendi"
}